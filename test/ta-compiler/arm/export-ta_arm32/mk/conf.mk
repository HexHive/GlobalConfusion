...
ta_arm32-platform-cflags := -mcpu=cortex-a53 -O0 -g3 -fpic -mthumb -fno-short-enums -fno-common -mno-unaligned-access -mfloat-abi=hard -funsafe-math-optimizations -funwind-tables
ta_arm32-platform-aflags := -pipe -g -mcpu=cortex-a53 -marm
ta_arm32-platform-cxxflags := -fpic -mcpu=cortex-a53 -Os -g3 -mfloat-abi=hard -funsafe-math-optimizations
