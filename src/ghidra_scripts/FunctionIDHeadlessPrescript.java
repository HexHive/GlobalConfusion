...
public class FunctionIDHeadlessPrescript extends GhidraScript {
	...
	private static final String DECOMPILER_PARAMETER_ID = "Decompiler Parameter ID";
        private static final String DECOMPILER_NON_RETURNING_FUNCTIONS_KNOWN = "Non-Returning Functions - Known";
        private static final String DECOMPILER_NON_RETURNING_FUNCTIONS_DISCOVERED = "Non-Returning Functions - Discovered";
	...
	protected void run() throws Exception {
		...
		if (options.containsKey(DECOMPILER_PARAMETER_ID)) {
			setAnalysisOption(currentProgram, DECOMPILER_PARAMETER_ID, "true");
                ...
                */
		setAnalysisOption(currentProgram, DECOMPILER_PARAMETER_ID, "false");
		//this function make the data flow analysis inacurrate, overreaching function boundaries
		//setAnalysisOption(currentProgram, DECOMPILER_NON_RETURNING_FUNCTIONS_KNOWN, "false");
		setAnalysisOption(currentProgram, DECOMPILER_NON_RETURNING_FUNCTIONS_DISCOVERED, "false");
